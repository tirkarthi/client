...
class EntryPoint(object):
    ...
    def compute_parameters(self, user_parameters):
        ...
        by the user. Report path will be return as parameter.
        """
...
class Parameter(object):
    ...
    def _compute_path_value(self, user_param_value, key_position):
    ...
    def compute_value(self, param_value, key_position):
        if self.type == "uri":
